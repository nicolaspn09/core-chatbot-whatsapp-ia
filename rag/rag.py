...
from langchain_community.document_loaders import PyPDFLoader, TextLoader, CSVLoader # O langchain possui vários loaders, além do PDF
...
if __name__ == "__main__":
    ...
    file_path = r"C:\Users\Nícolas Nasário\OneDrive\Cursos online\Treinamento Python - Hashtag\Códigos\ChatBotWhats\rag\data\Investimentos\Investimentos.txt"
    ...
    # persist_directory = r"C:\Users\Nícolas Nasário\OneDrive\Cursos online\Treinamento Python - Hashtag\Códigos\ChatBotWhats\chroma_data"
    persist_directory = r"C:\Users\Nícolas Nasário\OneDrive\Cursos online\Treinamento Python - Hashtag\Códigos\ChatBotWhats\chroma_data_invest"
